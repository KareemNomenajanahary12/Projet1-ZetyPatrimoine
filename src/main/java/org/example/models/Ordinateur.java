...
public class Ordinateur extends Possession {
    public static final double TAUX_DEPRECIATION_ANNUEL = -0.10;

    public Ordinateur(double valeurInitiale, LocalDate dateAchat) {
